...
<article>
<h1>Notice</h1>
<form action="nWritePro.jsp" method="post" name="fr" enctype="multipart/form-data">
...
<input type="hidden" name="pageNum" value=<%=pageNum%>>
	<div class="write_subject">
		...
		<input type="file" id="file" value="파일 업로드" class="upload" name="file" onchange="updateImageDisplay()">
